...
public interface PiPacketRegistry {
    ...
    /**
     * Finds a binding by authored packet type.
     */
    <T> Optional<PiPacketBinding<T, ?>> find(Class<T> type);

    /**
     * Requires a binding by authored packet type.
     */
    ...
    /**
     * Returns known packet ids in stable author-facing order.
     */
    ...
    /**
     * Returns known packet types in stable author-facing order.
     */
